...
class PerabotanCategoryPage extends StatelessWidget {
  const PerabotanCategoryPage({Key? key})
      : super(key: key);
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    "kategoris.perabotan!.tokos.namaToko",
                                    style: TextStyle(
                                        fontSize: 14,
  ...
  // Widget _buildToko(BuildContext context, Kategori tokos) {
