...
class BahanBangunanCategoryPage extends StatelessWidget {
  const BahanBangunanCategoryPage({Key? key}) : super(key: key);

  @override
  Widget _buildListPerabotanItem(BuildContext context) {
    return FutureBuilder<String>(
      future: DefaultAssetBundle.of(context)
          .loadString('assets/json/local_toko_bahan_bangunan.json'),
      builder: (context, snapshot) {
        final List<BahanBangunan> bahanBangunan =
            parseTokoBahanBangunan(snapshot.data);
        return ListView.builder(
          shrinkWrap: true,
          physics: const NeverScrollableScrollPhysics(),
          itemCount: bahanBangunan.length,
          itemBuilder: (context, index) {
            return _cardPerabotanItem(context, bahanBangunan[index]);
          },
        );
      },
    );
  ...
  @override
  Widget _cardPerabotanItem(BuildContext context, BahanBangunan bahanBangunan) {
    return SizedBox(
      child: Column(
